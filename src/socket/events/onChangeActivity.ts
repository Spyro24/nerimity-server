...
export const debouncedChangeActivity = debounceByKey(changeActivity, 1000, (userId) => userId, 1000);
...
function changeActivity(userId: string, socket: Socket, payload: Activity[] | null) {
